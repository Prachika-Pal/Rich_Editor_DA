...
import { PRICE_SYMBOL_PROVIDER } from "./price-symbol/price-symbol.provider";
import { CHARGES_TABLE_PROVIDER } from "./charges-table/charges-table.provider";
...
@NgModule({
    providers: [
        ...
        PRICE_SYMBOL_PROVIDER,
        CHARGES_TABLE_PROVIDER
    ],
    imports: [
        CommonModule
    ]
